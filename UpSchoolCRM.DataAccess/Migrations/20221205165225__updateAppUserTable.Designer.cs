...
namespace UpSchoolCRM.DataAccess.Migrations
{
    ...
    [Migration("20221205165225__updateAppUserTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UpSchoolCRM.EntityLayer.Concrete.Announcement", b =>
                {
            ...
            modelBuilder.Entity("UpSchoolCRM.EntityLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("UpSchoolCRM.EntityLayer.Concrete.Contact", b =>
                {
            ...
            modelBuilder.Entity("UpSchoolCRM.EntityLayer.Concrete.Customer", b =>
                {
            ...
            modelBuilder.Entity("UpSchoolCRM.EntityLayer.Concrete.Employee", b =>
                {
            ...
            modelBuilder.Entity("UpSchoolCRM.EntityLayer.Concrete.Supplier", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("UpSchoolCRM.EntityLayer.Concrete.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UpSchoolCRM.EntityLayer.Concrete.Employee", b =>
                {
                    b.HasOne("UpSchoolCRM.EntityLayer.Concrete.Category", "Category")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("UpSchoolCRM.EntityLayer.Concrete.EmployeeTask", b =>
                {
                    b.HasOne("UpSchoolCRM.EntityLayer.Concrete.AppUser", "AppUser")
